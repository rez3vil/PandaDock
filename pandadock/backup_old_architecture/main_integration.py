...
def add_hardware_options(parser):
    ...
    hw_group.add_argument('--use-gpu', action='store_true', help='Use GPU acceleration if available')
    hw_group.add_argument('--gpu-id', type=int, default=0, help='GPU device ID to use (default: 0)')
    ...
    hw_group.add_argument('--cpu-workers', type=int, default=None, help='Number of CPU workers for parallel processing')
    hw_group.add_argument('--cpu-affinity', action='store_true', help='Set CPU affinity for performance')
    hw_group.add_argument('--workload-balance', type=float, default=None, help='GPU/CPU workload balance (0.0-1.0)')
    hw_group.add_argument('--auto-tune', action='store_true', help='Auto-tune hardware parameters')
